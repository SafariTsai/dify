...
if (process.env.NEXT_PUBLIC_API_PREFIX && process.env.NEXT_PUBLIC_PUBLIC_API_PREFIX) {
  ...
  apiPrefix = 'https://dify.zqfw.site/console/api'
  publicApiPrefix = 'https://dify.zqfw.site/api' // avoid browser private mode api cross origin
  marketplaceApiPrefix = 'https://dify.zqfw.site/api'
}
